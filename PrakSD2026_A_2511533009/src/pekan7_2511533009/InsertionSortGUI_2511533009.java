...
public class InsertionSortGUI_2511533009 extends JFrame {
     ...
     * Create the frame.
     */
    public InsertionSortGUI_2511533009() {
    ...
    private void setArrayFromInput_3009(){
        ...
        try{
            for (int k_3009 = 0;k_3009<parts_3009.length;k_3009++){
                array_3009[k_3009] = Integer.parseInt(parts_3009[k_3009].trim());}
        ...
        for (int k_3009 = 0;k_3009<array_3009.length;k_3009++){
            labelArray_3009[k_3009] = new JLabel(String.valueOf(array_3009[k_3009]));
            labelArray_3009[k_3009].setFont(new Font("Arial",Font.BOLD,24));
            labelArray_3009[k_3009].setBorder(BorderFactory.createLineBorder(Color.BLACK));
            labelArray_3009[k_3009].setHorizontalAlignment(SwingConstants.CENTER);

            panelArray_3009.add(labelArray_3009[k_3009]);
        }
    ...
    public static void main(String[] args){
        SwingUtilities.invokeLater(() -> {
            InsertionSortGUI_2511533009 gui_3009 = new InsertionSortGUI_2511533009();
